...
def render_video(vertices, cameras, faces, image_size=400, device=None, add_border=True, last_t_green_border=10000,
    ...
    if adapt_camera:
        cam = find_best_camera_for_video(vertices.cpu(), factor=1.4, n_jts_to_take=256)
        cameras[:] = cam
    ...
    range_x = [color_start[0] for _ in range(seq_len)] if color_start[0] == color_end[0] else np.arange(color_start[0],
                                                                                                        color_end[0], (
                                                                                                                    color_end[
                                                                                                                        0] -
                                                                                                                    color_start[
                                                                                                                        0]) / seq_len).tolist()
    range_y = [color_start[1] for _ in range(seq_len)] if color_start[1] == color_end[1] else np.arange(color_start[1],
                                                                                                        color_end[1], (
                                                                                                                    color_end[
                                                                                                                        1] -
                                                                                                                    color_start[
                                                                                                                        1]) / seq_len).tolist()
    range_z = [color_start[2] for _ in range(seq_len)] if color_start[2] == color_end[2] else np.arange(color_start[2],
                                                                                                        color_end[2], (
                                                                                                                    color_end[
                                                                                                                        2] -
                                                                                                                    color_start[
