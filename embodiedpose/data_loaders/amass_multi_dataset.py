...
class AMASSDatasetMulti(DatasetBatch):
    ...
    def sample_seq(
        ...
        for i in range(num_people):
            ...
            samples.append(self.get_sample_from_key(self.curr_key, full_sample=full_sample, precision_mode=precision_mode,
                                                    fr_num=fr_num, freq_dict=freq_dict, sampling_freq=sampling_freq,
                                                    return_batch=return_batch, fr_start=fr_start))
        return samples