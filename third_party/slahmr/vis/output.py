...
from embpose_util.tensor import detach_all, to_torch, move_to
...
def animate_scene(
    ...
    **kwargs,
    ...
    if len(render_views) < 1:
        return
    # rendering main function, builds the whole 3D scene to be rendered
