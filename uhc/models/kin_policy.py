...
class KinPolicy(Policy):
    ...
    def select_action(self, x, mean_action=False):
        # x --> shape is ([1, 6455])
        # DiagGaussian(action_mean, action_std), action_mean, action_std
        # dist --> is DiagGaussian(action_mean, action_std)
        # here actually calls models/kin_policy_humor_res.py --> forward()
