...
def smpl_2_entry(
    ...
    # qpos = smpl_to_qpose(pose=pose_aa, mj_model=mj_model, model=humanoid_model, trans=trans)
    qpos = smpl_to_qpose(pose=pose_aa, mj_model=mj_model, model="smpl", trans=trans)
...
if __name__ == "__main__":
    ...
    # data_dir = "/home/nugrinovic/code/CVPR_2024/EmbodiedPose/sample_data/amass_copycat_take5_test_small.pkl"
    # data_dir = "/home/nugrinovic/code/CVPR_2024/EmbodiedPose/sample_data/standing_neutral.pkl"
    data_dir = "/home/nugrinovic/code/CVPR_2024/EmbodiedPose/sample_data/thirdeye_anns_prox_overlap_no_clip.pkl"
    ...
    xml_str = smpl_robot.export_xml_string().decode("utf-8")
    mj_model = mujoco_py.load_model_from_xml(xml_str)
